...
def start_analysis(repo_url: str, ref: str, docs_url: str, scope_notes: str):
    ...
    # Fetch results
    try:
        # NOTE: The API layer guarantees all responses are already sanitized
        # (pipeline sanitizes before persistence; API re-sanitizes as defense-in-depth).
        # No client-side sanitization is needed.
